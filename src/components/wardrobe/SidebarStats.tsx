import { TrendingUp, Package, Shirt, PaintBucket, AlertTriangle } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Progress } from '@/components/ui/progress';
import { PieChart, Pie, Cell, BarChart, Bar, XAxis, YAxis, ResponsiveContainer, Tooltip } from 'recharts';
import { useWardrobeStats } from '@/hooks/useWardrobe';
import { TypeKind } from '@/types/wardrobe';
...
// Remove emoji icons for cleaner design
    ...
    <aside className={cn("w-80 space-y-6", className)}>
      ...
      <Card>
        ...
        <CardContent>
          <div className="h-40">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={colorData} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
                <XAxis 
                  dataKey="name" 
                  tick={{ fontSize: 12 }}
                  angle={-45}
            ...
            <div key={item.id} className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Progress value={(item.timesWorn / 40) * 100} className="h-1 flex-1" />
      ...
      {neverWorn.length > 0 && (
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              These items haven't been worn recently. Consider donating them:
            </p>
